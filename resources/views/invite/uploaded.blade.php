                                                ...
                                                <tr>
                                                   <td align="left" style="padding:0;Margin:0">
                                                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                            {{ $params['user_name'] }}, мы подготовили письмо-вызов для вашей организации. Письмо-вызов находится в приложении к данному письму, а также в вашем личном кабинете на платформе «Твое.Событие».
                                                        </p>
                                                        <br />
                                                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                            Пожалуйста, проверьте письмо при получении! В случае наличия в нем ошибок, настоятельно рекомендуем незамедлительно обратиться!
                                                        </p>
                                                   </td>
                                                </tr>
                                             </table>
