                                                      ...
                                                      <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                         <tr>
                                                            <td align="center" class="es-m-txt-l" style="padding:0;Margin:0;font-size:0">
                                                                <img class="img-9919" src="{{ asset('public/images/logo.png') }}" alt="" width="246" height="34" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                            </td>
                                                         </tr>
                                                      </table>
                                                   </td>
                                                ...
                                                <tr>
                                                   <td align="left" style="padding:0;Margin:0">
                                                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                            {{ $params['user_name'] }}, мы получили ваше обращение в поддержку и зарегистрировали его. Номер вашего обращения — <b>№ {{ $params['ticket_code'] }}</b>.
                                                        </p>
                                                        <br />
                                                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                            Пожалуйста, обратите внимание, что обработка вашего обращения может занять какое-то время (до 24 часов). Мы обязательно свяжемся с вами по электронной почте, указанной в аккаунте или указанному номеру телефона!
                                                        </p>
                                                   </td>
                                                </tr>
                                             </table>
                                                      ...
                                                      <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                         ...
                                                         <tr>
                                                            <td align="left" style="padding:0;Margin:0">
                                                               ...
                                                               <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">АНО «Новые Национальные Медиа»</p>
                                                            </td>
                                                         </tr>
                                                      </table>
                                                   </td>
