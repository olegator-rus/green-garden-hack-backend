...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="ru">
   <head>
      ...
      <title>Аккаунт успешно создан</title>
      <!--[if (mso 16)]>
      ...
      <style type="text/css">.rollover:hover .rollover-first { max-height:0px!important; display:none!important; } .rollover:hover .rollover-second { max-height:none!important; display:inline-block!important; } .rollover div { font-size:0px; } u + .body img ~ div div { display:none; } #outlook a { padding:0; } span.MsoHyperlink,span.MsoHyperlinkFollowed { color:inherit; mso-style-priority:99; } a.es-button { mso-style-priority:100!important; text-decoration:none!important; } a[x-apple-data-detectors] { color:inherit!important; text-decoration:none!important; font-size:inherit!important; font-family:inherit!important; font-weight:inherit!important; line-height:inherit!important; } .es-desk-hidden { display:none; float:left; overflow:hidden; width:0; max-height:0; line-height:0; mso-hide:all; } .es-button-border:hover > a.es-button { color:#ffffff!important; }
         ...
         table.es-table-not-adapt, .esd-block-html table { width:auto!important } .es-social td { padding-bottom:10px } .h-auto { height:auto!important } .img-9919 { width:200px!important } }
      </style>
   </head>
                                                ...
                                                <tr>
                                                   <td class="es-m-p0r es-m-p20b" valign="top" align="center" style="padding:0;Margin:0;width:180px">
                                                      <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                         <tr>
                                                            <td align="center" class="es-m-txt-l" style="padding:0;Margin:0;font-size:0">
                                                                <img class="img-9919" src="{{ asset('images/logo.png') }}" alt="" width="246" height="34" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                            </td>
                                                         </tr>
                                                      </table>
                                                   </td>
                                                ...
                                                <tr>
                                                   <td align="left" style="padding:0;Margin:0">
                                                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                            {{ $params['user_name'] }}, добро пожаловать на платформу — «Твое.Событие»! Мы рады сообщить, что ваша регистрация на платформе с расписанием Всероссийского студенческого форума «Твой Ход» 2023 прошла успешно!</b>
                                                        </p>
                                                        <br />
                                                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">
                                                            Для дальнейшего использования платформы вводите следующий логин и пароль: <b>{{ $params['user_email'] }}</b> / <b>{{ $params['user_password'] }}</b>. Ссылку на платформу вы получите позже в официальном канале Форума.
                                                        </p>
                                                   </td>
                                                </tr>
                                             </table>
                                                ...
                                                <tr>
                                                   <td class="es-m-p20b" align="left" style="padding:0;Margin:0;width:270px">
                                                      <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                         ...
                                                         <tr>
                                                            <td align="left" style="padding:0;Margin:0">
                                                               <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">С уважением,</p>
                                                               <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Всероссийский студенческий проект «Твой Ход»</p>
                                                            </td>
                                                         </tr>
                                                      </table>
                                                   </td>
